...
{
    class Користувачі_ТабличнаЧастина_Контакти : ДовідникТабличнаЧастина
    {
        ...
        public Користувачі_ТабличнаЧастина_Контакти()
        {
        ...
        public override async ValueTask SaveRecords()
        {
            if (ЕлементВласник != null)
            {
                ...
                {
                    ЕлементВласник.Контакти_TablePart.Records.Add(new Користувачі_Контакти_TablePart.Record()
                    {
                        UID = запис.ID,
                        Тип = запис.Тип,
                        Значення = запис.Значення,
